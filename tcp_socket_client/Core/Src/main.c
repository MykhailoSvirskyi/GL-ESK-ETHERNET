...
osThreadId updServerTaskHandle;
/* USER CODE BEGIN PV */
...
extern void StartUpdServerTask(void const * argument);
...
int main(void)
{
  ...
  /* definition and creation of updServerTask */
  osThreadDef(updServerTask, StartUpdServerTask, osPriorityNormal, 0, 2048);
  updServerTaskHandle = osThreadCreate(osThread(updServerTask), NULL);
